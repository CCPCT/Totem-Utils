...
public class configScreen extends Screen {
    ...
    public static Screen getConfigScreen(Screen parent) {
        ...
        generalTab.addEntry(entryBuilder.startIntField(Text.literal("Auto Totem Delay"), ModConfig.get().autoTotemDelay)
                .setTooltip(Text.literal("how long to wait before autototeming, in ticks"))
                .setDefaultValue(0)
